...
Cropt aims to be a privacy-respecting, fully open source alternative to existing feed-based social platforms — with a best-in-class meme editor at its core. The source code is public so you can verify exactly what we collect (which is as little as possible).
